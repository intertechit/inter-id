...
export default function RareRozetSahipleri() {
  return (
    <Layout>
      ...
      <div className="main-container-middle">
        <div className="banner">
          <div className="banner-container">
            ...
            <ul>
              <li>
                <a href="/siralamalar">Rozet Toplayıcılar</a>
              </li>
              <li>
                <a href="/yildiz-toplayicilar">Yıldızlar</a>
              </li>
              <li>
                <a href="/legendary-sahipleri">Legendary Rozet Sahipleri</a>
              </li>
              <li>
                <a href="/unique-sahipleri">Unique Rozet Sahipleri</a>
              </li>
              <li>
                <a href="#">Rare Rozet Sahipleri</a>
              </li>
              <li>
                <a href="/uncommon-sahipleri">Uncommon Rozet Sahipleri</a>
              </li>
              <li>
                <a href="/common-sahipleri">Common Rozet Sahipleri</a>
              </li>
            </ul>
          </div>
        </div>
